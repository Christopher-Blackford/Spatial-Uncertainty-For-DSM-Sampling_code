...
print(paste0("Done ", Soil_Variable[i], " Round 1"))
}
...
for(i in 1:length(Soil_Variable)){
for(j in 1:length(Dataset2_subset)){

#Random
R2_Random <- list.files(paste0(wd, "Model_Comparison/models/Round2"), pattern = paste0(Dataset2_subset[j], "_RANDOM_", Soil_Variable[i], ".rds"))
R2_Random_readme <- list.files(paste0(wd, "Model_Comparison/models/Round2"), pattern = paste0(Dataset2_subset[j], "_RANDOM_", Soil_Variable[i], ".rds"), full.names = T)
...
#Treatment
R2_Treatment <- list.files(paste0(wd, "Model_Comparison/models/Round2"), pattern = paste0(Dataset2_subset[j], "_HIGH_", Soil_Variable[i], ".rds"))
R2_Treatment_readme <- list.files(paste0(wd, "Model_Comparison/models/Round2"), pattern = paste0(Dataset2_subset[j], "_HIGH_", Soil_Variable[i], ".rds"), full.names = T)
...
print(paste0("Done ", Soil_Variable[i], " ", Dataset2_subset[j]))
}
}
